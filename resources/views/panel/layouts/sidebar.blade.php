...
<div class="sidebar">
    <!-- Start Logobar -->
    <div class="logobar">
        <a href="index.html" class="logo logo-large"><img src="{{ asset('Panel/images/logo.svg') }}" class="img-fluid" alt="logo"></a>
        <a href="index.html" class="logo logo-small"><img src="{{ asset('Panel/images/small_logo.svg') }}" class="img-fluid" alt="logo"></a>
    </div>
    <!-- End Logobar -->
    <!-- Start Navigationbar -->
        ...
        <ul class="vertical-menu">
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/dashboard.svg') }}" class="img-fluid" alt="dashboard"><span>Dashboard</span><i class="feather icon-chevron-right"></i>
                </a>
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/basic.svg') }}" class="img-fluid" alt="basic"><span>Basic UI</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/advanced.svg') }}" class="img-fluid" alt="advanced"><span>Advanced UI</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/apps.svg') }}" class="img-fluid" alt="apps"><span>Apps</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/form_elements.svg') }}" class="img-fluid" alt="form_elements"><span>Forms</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/chart.svg') }}" class="img-fluid" alt="chart"><span>Charts</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/icons.svg') }}" class="img-fluid" alt="icons"><span>Icons</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/tables.svg') }}" class="img-fluid" alt="tables"><span>Tables</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/maps.svg') }}" class="img-fluid" alt="maps"><span>Maps</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
            ...
            <li>
                <a href="widgets.html">
                    <img src="{{ asset('Panel/images/svg-icon/widgets.svg') }}" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-success pull-left">New</span>
                </a>
            </li>
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/pages.svg') }}" class="img-fluid" alt="pages"><span>Pages</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
                    <li>
                        <a href="javaScript:void();">Basic<i class="feather icon-chevron-right"></i></a>
                        <ul class="vertical-submenu">
                    ...
                    <li>
                        <a href="javaScript:void();">Authentications<i class="feather icon-chevron-right"></i></a>
                        <ul class="vertical-submenu">
            ...
            <li>
                <a href="javaScript:void();">
                    <img src="{{ asset('Panel/images/svg-icon/ecommerce.svg') }}" class="img-fluid" alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
