    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container-fluid px-3 px-xl-5">
            <a class="navbar-brand" href="index.html">
                <img class="light-mode-item navbar-brand-item" src="{{ asset('app/assets/images/logo.webp') }}" alt="لوگوی devcode" fetchpriority="high" decoding="async">
                <img class="dark-mode-item navbar-brand-item" src="{{ asset('app/assets/images/logo.webp') }}" alt="لوگوی devcode" fetchpriority="high" decoding="async">
            </a>
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.html">صفحه اصلی devcode</a>
                    </li>
